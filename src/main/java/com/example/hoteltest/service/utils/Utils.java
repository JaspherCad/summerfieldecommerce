package com.example.hoteltest.service.utils;
...
import com.example.hoteltest.dto.RoomDTO;
...
public class Utils {
    ...
    public static UserDTO mapUserEntityToUserDTOPlusUserBookingsAndRoom(User user) {
        ...
        if (!user.getBookings().isEmpty()) {
            userDTO.setListOfBookings(user.getBookings().stream().map(booking -> mapBookingEntityToBookingDTOPlusBookedRooms(booking, false)).collect(Collectors.toList()));
        }
        return userDTO;
    }
    ...
    public static List<BookingsDto> mapBookingListEntityToBookingListDTO(List<Booking> bookingList) {
