...
public class RefreshTokenService {
    ...
    public RefreshToken createRefreshToken(String username){
        ...
        if (existingToken != null) {
            ...
            existingToken.setExpiryDate(Instant.now().plusMillis(600000 * 1000)); // 10 minutes
//            existingToken.setExpiryDate(Instant.now().plusMillis(7 * 24 * 60 * 60 * 1000)); // 10 minutes
     ...
     // If no token exists, create a new one
        RefreshToken newRefreshToken  = RefreshToken.builder()
                ...
                .expiryDate(Instant.now().plusMillis(600000 * 1000)) // set expiry of refresh token to 10 minutes - you can configure it application.properties file 
                .build();
